	...
	Photostack.prototype._initEvents = function () {
		var self = this,
			...
			open = function () {
				...
				if (beforeStep) {
					this.removeEventListener('mouseover', open);
		...
		if (beforeStep) {
			this._shuffle();
			this.el.addEventListener('mouseover', open);
		} else {
			open();
		}
		var maxPhoto = 0;
		...
		function autoplay() {
			...
			if (currentPhoto > maxPhoto - 2) currentPhoto = -1;
		}
